...
yy=[0   0.40 0.80 1.2 1.6 2.21 2.61 3.05 ];
xx=[588 441  323  247 188 117  58  0 ];
xx=xx.*4;
...
for Qexmincfm=0:0.5:xx(I)
  ...
  Vmin2(i)=(Q2(i)*1.69901082/(Areafiltro1))/3600;%m/s
...
legend('Caudal','Presion Filtros','Caudal con menos velocidad')
grid
subplot(1,3,3)
