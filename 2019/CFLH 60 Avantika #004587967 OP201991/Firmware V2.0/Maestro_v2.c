...
int16 tiempos=0;
int8 i=0;
short Flanco=0,Flanco1=0,Flanco2=0,Flanco3=0,Flanco4=0,Flanco5=0,Flanco6=0,imprimir=0,flag_uv=0,flag_blower=0,flag_toma=0,flag_luz=0,flag_alarma=0,w=0,flag_activo=0;
...
char  Baje_Vidrio[] = "!!Ubique Vidrio!!",Inflowt[] = "Presion:",Downflowt[] = "JPCFLH", ZF[] = "Fabrica:203.0", ZA[] = "Actual:",AJ[]="Ajuste:";
char  Vida_UV[] = "UVLife:",Vida_Filtro[] = "Filter:",ZFP[] = "Fabrica:235.0", Perdida[]="!Perdida Flujo!",TimeUV[]="TimeUV";
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      {         
         ...
         glcd_text57(0, 55, TimeUV, 1, ON);
         UVTime=Tuv[0]+(Tuv[1]*10)+(Tuv[2]*100)+(Tuv[3]*1000); 
         displayTiempo(Tempouv[3],40,55,0,1);
         displayTiempo(Tempouv[2],47,55,0,1);
         glcd_text57(54, 56, Dos_puntos, 1, ON);
         displayTiempo(Tempouv[1],57,55,0,1);
         displayTiempo(Tempouv[0],64,55,0,1);
         
         if(imprimir==1){
            displayfloat(Leer_Sensor_Presion(8),70,15,0,1);
            imprimir=0;
         }
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      if(Menu==41){ //Menu de Sensor de Presión.
