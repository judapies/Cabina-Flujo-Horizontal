...
void LeeEEPROM(void){
   ...
   Pinicial=read_eeprom(40);
   delay_ms(10);
   Pfinal=read_eeprom(41);
   delay_ms(10);
...
void LimitaValores(void){
   ...
   if(Ajuste1>4.0){
      Ajuste1=0.6;write_eeprom(25,0);write_eeprom(26,60);
   }
   if(Ajuste2>4.0){
   ...
   if(Relacion>1.0){
      Relacion=0.77;write_eeprom(35,0);write_eeprom(36,77);
   }
   if(Pinicial>100){
      Pinicial=50;write_eeprom(40,50);
   }
   if(Pfinal>100){
      Pfinal=20;write_eeprom(41,20);
   }
   if(Diferencia>50){
